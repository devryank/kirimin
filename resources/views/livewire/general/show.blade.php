                    ...
                    <div class="col-span-4 lg:col-span-4 md:flex md:items-center md:justify-center">
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-8 flex">
                                <button wire:click="decreaseQty"
                                    class="mt-1 font-semibold rounded-full border bg-green-500 text-white h-8 w-16 focus:outline-none cursor-pointer">
                        ...
                        <div class="md:flex">
                            <button wire:click="createOrderUnit({{$key}})"
                                class="flex-1 mr-2 mb-2 md:mb-0 px-3 py-2 bg-green-500 text-white text-xs md:text-md"
                                style="white-space: nowrap">
                                Beli per {{ $product->unit->name }}
                            </button>
                            @if ($product->custom_price)
                            <button wire:click="createOrderSingle({{$key}})"
                                class="flex-1 px-3 py-2 bg-green-500 text-white text-xs md:text-md"
                                style="white-space: nowrap">
                                Beli Eceran
                            </button>
                        </div>
