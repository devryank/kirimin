<div>
    ...
    @if ($failDelivery)
    @livewire('delivery.failed')
    @endif
    @if ($checkDelivery)
    @livewire('delivery.success')
    @endif
    <h1 class="text-3xl text-black dark:text-white pb-6">Pengiriman</h1>
                        ...
                        <tr>
                            ...
                            <td class="w-1/3 text-left py-3 px-4">
                                <div class="flex space-x-2">
                                    ...
                                    <button wire:click="showDelivery({{$transaction->user_id}})"
                                    ...
                                    OR Auth::user()->hasRole('super-admin'))
                                    <button wire:click="deleteDelivery({{$transaction->id}})"
            ...
            <table class="min-w-full bg-white dark:bg-gray-800"
                ...
                <tbody class="text-gray-700 dark:text-white">
                    ...
                    <tr>
                        ...
                        <td class="text-left py-3 px-4">
                            <button class="w-12 p-2 text-white font-light tracking-wider bg-red-700 rounded"
                                wire:click="failedDelivery({{$item->id}})">
                                <i class="fas fa-times"></i>
                            </button>
                            <button class="w-12 p-2 text-white font-light tracking-wider bg-blue-700 rounded"
                                wire:click="successDelivery({{$item->id}})">
                                <i class="fas fa-check"></i>
                            </button>
                        </td>
                    </tr>
